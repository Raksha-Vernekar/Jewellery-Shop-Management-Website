...
$sql = "select u.userid as userid ,u.username,o.id as orderid,o.totamt,o.orderdate FROM 
        user u, orderplaced o
...
.button {
  ...
  <tbody>
        ...
        <td><div style="word-wrap: break-word;"><?php echo $rows['totamt'];?></div></td> 
				<td><div style="word-wrap: break-word;"><?php echo $rows['orderdate'];?></div></td> 
        </form>
			</tr> 
...
?>
	...
	<form action="trackorder.php" method="POST" enctype="multipart/form-data">
		...
		<label>
			ORDER ID <input type="text" id="oid" name="oid" required>
		</label>
		<label>
